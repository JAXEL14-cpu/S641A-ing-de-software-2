...
// Clase que controla el flujo del juego de lucha, administra los turnos y determina el ganador de la pelea.
...
public class JuegoLucha {
    ...
    // Inicia la pelea entre los dos personajes. Alterna los turnos hasta que uno quede sin puntos de vida.
    ...
    private void turno(Personaje atacante, Personaje defensor) {
        System.out.println("Turno de " + atacante.getNombre() +
                ". Puntos de vida de " + defensor.getNombre() + ": " + defensor.getPuntosDeVida());
